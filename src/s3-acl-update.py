...
def update_acl(bucket, key):
    ...
    try:
        # Assume role into the object owner's account and update the object acl with given bucket and key 
...
# Define configs for sending event messages to a Slack channel
